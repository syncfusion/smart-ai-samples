import {
    Inject, PivotViewComponent, FieldList, CalculatedField, Toolbar, ConditionalFormatting,
        ...
        <>
            <div className="description-container e-card">
                <div className='e-card-content '>
                    <p>
                        The <b>Pivot</b>, enhanced with AI, offers features such as <i>Smart Data Aggregation</i>, <i>Predictive Modeling</i>, and <i>Adaptive Filtering</i>. Click the <mark><b>AI Assist</b></mark> option to explore these AI-powered capabilities.
                        Know more <a href="https://github.com/syncfusion/smart-ai-samples/blob/master/react/src/app/pivot-table/Readme.md">here</a>.
                    </p>
                </div>
            </div>
            <div id="container">
                ...
                <PivotViewComponent
                    ...
                    toolbarRender={(args) => {
                        ...
                        (args.customToolbar as any[]).splice(6, 0, {
                            text: 'AI Assist', tooltipText: 'AI Assist', prefixIcon: 'e-icons e-assistview-icon',
