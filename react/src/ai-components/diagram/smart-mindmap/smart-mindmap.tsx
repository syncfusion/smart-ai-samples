        ...
        <>
            <div className="description-container e-card">
                <div className="e-card-content">
                    <p>
                        This demo showcases the React Diagram Component used to create an AI-assisted mindmap diagrams. It features nodes and connectors for visually organizing ideas and concepts, ideal for brainstorming and mapping complex information.
            ...
            <div className="container">
                ...
                <FabComponent id="ai-assist"
                    isPrimary={true} content='AI Assist' iconCss='e-icons e-assistview-icon'
