...
import { OpenAiModelKanban } from "../../../azure-openai";
            ...
            <div className="description-container e-card">
                <div className="e-card-content">
                    <p>Click the <strong>Analyze Customer Sentiments</strong> button to have AI generate emoticon expressions based on customer feedback for delivered items and update them in the Syncfusion Kanban Board.
                        Know more <a href="https://github.com/syncfusion/smart-ai-samples/blob/master/react/src/ai-components/kanban/Readme.md">here</a>.
                    </p>
                </div>
            </div>
