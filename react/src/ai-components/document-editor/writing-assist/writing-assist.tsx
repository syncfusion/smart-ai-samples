        ...
        <>
            <div className="description-container e-card">
                <div className='e-card-content '>
                    <p>The Writing Assist feature in the Syncfusion React Document Editor helps users generate new content based on their ideas or prompts. It integrates seamlessly into the editor, suggesting relevant text that can be directly inserted into the document, facilitating a smooth writing process. Know more <a href="https://github.com/syncfusion/smart-ai-samples/blob/master/react/src/ai-components/document-editor/Readme.md">here</a>.
                    </p>
                </div>
            </div>
