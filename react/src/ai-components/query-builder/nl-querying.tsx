...
import { getAzureTextAIRequest } from '../../ai-models';
        ...
        <div className='control-pane'>
            <div className='control-section'>
                <div className="description-container e-card">
                    ...
                    <p>The Query Builder, enhanced with AI, offers feature like enter a plain language query and click Run Query. The entered query will automatically be converted into database queries, simplifying data retrieval and insights. Know more here <a href="https://github.com/syncfusion/smart-ai-samples/blob/master/react/src/ai-components/query-builder/Readme.md">here</a>.</p>
                    </div>
                </div>
                <div id="wrapper">
                    <TabComponent id="tab">
