            ...
            <div className='control-section'>
                <div className="description-container e-card">
                    <div className='e-card-content '>
                        <p>This sample uses AI to identify critical tasks based on the project schedule. The AI then prompts for resource reassignment and generates a summary outlining the reallocation process and details of the critical tasks. Know more <a href="https://github.com/syncfusion/smart-ai-samples/blob/master/react/src/ai-components/gantt/Readme.md">here</a>.</p>
                    </div>
                </div>
                <div id='container'>
                    <GanttComponent
