    ...
    return (
        <>
            <div className="description-container e-card">
                <div className='e-card-header-title' style={{ fontWeight: "600" }}>AI-Powered SpreadSheet</div>
                <div className='e-card-content '>
                    <p>
                        This sample demonstrates the integration of AI to automatically analyze content, generate formulas, and validate them in the Spreadsheet.
                    </p>
                </div>
            </div>
