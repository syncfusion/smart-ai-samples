...
import { OpenAiModelRTE } from '../../ai-models';
        ...
        items: [
            {
                ...
                template:
                    '<button class="e-tbar-btn e-btn" tabindex="-1" id="ai_assistant_button_tbar" style="width:100%"><span style="padding-right:5px;font-size:16px" class="e-btn-icon e-icons e-assistview-icon e-icon-left"></span><div class="e-rte-dropdown-btn-text">AI Assist</div></button>'
            },
            {
        ...
        <>
            <div className="description-container e-card">
                <div className='e-card-content '>
                    <p>
                    The <b>Rich Text Editor</b>, enhanced with AI, offers features such as content generation, summarization, rephrasing, translation, and grammar correction. Click <code><mark><b>AI Assistant</b></mark></code> option to explore these AI-powered capabilities. Know more <a href='https://github.com/syncfusion/smart-ai-samples/blob/master/react/src/ai-components/rich-text-editor/Readme.md'>here</a>.
                    </p>
                </div>
            </div>
