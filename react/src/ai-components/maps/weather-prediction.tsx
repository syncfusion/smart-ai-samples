            ...
            <div className='control-section'>
                <div className="description-container e-card">
                    <div className='e-card-content'>
                        <p>Syncfusion React Maps integrated with AI to automatically forecast weather conditions in the United States for the next five days. Know more <a href="https://github.com/syncfusion/smart-ai-samples/blob/master/react/src/ai-components/maps/Readme.md">here</a>.</p>
                    </div>
                </div>
                <div id='container'>
                    <MapsComponent
