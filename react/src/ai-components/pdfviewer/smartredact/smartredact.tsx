        ...
        <>
            <div className="description-container e-card">
                <div className='e-card-content'>
                    <p>This sample shows how the Syncfusion React PDF Viewer uses AI to intelligently redact sensitive information. Users can select patterns like emails or names, and the AI will identify and redact sensitive data based on these patterns.
