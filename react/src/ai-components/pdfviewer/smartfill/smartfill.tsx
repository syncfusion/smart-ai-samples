        ...
        <>
            <div className="description-container e-card">
                <div className='e-card-content'>
                    <p>Copy the sample content and click <b>Smart Form Fill</b>. The AI will process the copied content to automatically populate the relevant fields in the PDF form, enhancing efficiency and minimizing manual entry errors. However, users should review and adjust the filled fields as necessary. Know more <a target="_blank" href="https://github.com/syncfusion/smart-ai-samples/blob/master/react/src/ai-components/pdfviewer/Readme.md">here</a>.</p>
                </div>
            </div>
