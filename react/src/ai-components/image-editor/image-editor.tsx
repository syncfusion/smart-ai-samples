        ...
        <>
            <div className="description-container e-card">
                <div className='e-card-content '>
                    <p>
                        The Image Editor, enhanced with AI, includes features like <i>Magic Eraser</i>, <i>Background Changer</i> and <i>Background Remover</i>. Click the Sidebar to explore these capabilities. The Image Editor uses the Stable Diffusion API for its AI features. Need to configure the Key in Sample.
                        Know more <a href="https://github.com/syncfusion/smart-ai-samples/blob/master/react/src/ai-components/image-editor/Readme.md">here</a>.
                    </p>
                </div>
            </div>
                ...
                <div id="wrapper-container"
                    ...
                    <div className="magic-eraser">
                        ...
                        <div className="lower-div">
                            <video muted={true} loop={true} autoPlay={true} preload="auto" src="https://www.fotor.com/photo-editor-app/ai/video/removerobj.mp4" style={{ width: "130px", height: "130px" }}></video>
