<template>
  <div class="control-pane">
    <div class="control-section">
      <h2 style="font-weight: 600; text-align:center">Natural Language Querying</h2>
      <div class="description-container e-card" id="desc-container">
        <div class="e-card-content">
          <p>The Query Builder, enhanced with AI, offers feature like enter a plain language query and click Run Query.
            The entered query will automatically be converted into database queries, simplifying data retrieval and
            insights. Know more <a
              href="https://github.com/syncfusion/smart-ai-samples/blob/master/vue/src/ai-components/ai-querybuilder/Readme.md">here</a>.
          </p>
        </div>
      </div>
      <div id="wrapper">
        ...
        <div id="prompt-ui">
          <div id="customTbarDialog">
            <span class="e-text" style="margin: 5px;">Query</span>
            <textarea id="text-area" aria-label="ai assistant query box"
              placeholder="find all users who lives in los angeles and have over 1000 credits"></textarea>
          </div>
        </div>
        <div style="display: none">
          <div id="querybuilder-ui">
            <ejs-querybuilder id="querybuilder" class="row" ref="qryBldrObj" :dataSource="users"
              :columns="columnData"></ejs-querybuilder>
          </div>
        </div>
        <div class="e-custom-elem">
          <ejs-button id="submit" iconCss="e-icons e-reset" @click="clicked" :isPrimary="true">Run Query</ejs-button>
        </div>
        <div class="e-custom-elem">
          <span class="e-text">Results from your AI generated Query</span>
          <ejs-grid id="grid" ref="gridInstance" :dataSource="users" :allowPaging="true"
            :pageSettings="{ pageSize: 10 }" style="margin-top: 10px">
            <e-columns>
  ...
  methods: {
    ...
    clicked() {
      ...
      aiOutput.then((result) => {
        ...
        this.$refs.gridInstance.ej2Instances.query = query;
