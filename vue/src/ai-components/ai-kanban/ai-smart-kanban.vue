<template>
    <h2 style="text-align: center;">Sentiment Analysis - Based on Customer Feedback</h2>
    <div class="description-container e-card">
        <div class='e-card-content '>
            <p>Click the <strong>Analyze Customer Sentiments</strong> button to have AI generate emoticon expressions
                based on customer feedback for delivered items and update them in the Syncfusion Kanban Board.
                Know more <a
                    href="https://github.com/syncfusion/smart-ai-samples/blob/master/vue/src/ai-components/ai-kanban/Readme.md">here</a>.
            </p>
        </div>
    </div>
                                                            ...
                                                            <template
                                                                ...
                                                                <tr>
                                                                    <td colspan="2">
                                                                        ...
                                                                        <span class="e-kanban-date">{{ data.Date
                                                                            }}</span>
                                                                    </td>
                                                                </tr>
                                                                <tr>
