<template>
  <div class='control-pane'>
    <div class='control-section'>
      ...
      <div id='container'>
        <ejs-gantt ref="ganttInstance" :dataSource="tasksCollection" :resources="resourceCollection"
          :taskFields="taskFields" :resourceFields="resourceFields" :editSettings="editSettings"
          :rowDataBound="rowDataBound" :queryTaskbarInfo="queryTaskbarInfo" :columns="columns" :toolbar="toolbarOptions"
          :toolbarClick="toolbarClick" :labelSettings="labelSettings" :splitterSettings="splitterSettings"
          :readOnly="false" :allowSelection="true" :highlightWeekends="true" :treeColumnIndex="1" :taskbarHeight="20"
          :rowHeight="40" height="550px">
          <e-columns>
        ...
        template: function () {
          return {
            template: createApp().component('ganttToolbarTemplate', {
              template: '<ejs-button id="toolbarButton" :isPrimary="true">Assign prioritize tasks</ejs-button>',
