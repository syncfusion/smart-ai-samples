    ...
    <div id="desc-container">
        ...
        <div class="description-container e-card">
            <div class='e-card-content '>
                <p>
                    This demo showcases the Vue Diagram Component used to create an AI-assisted mindmap diagrams.
                    It features nodes and connectors for visually organizing ideas and concepts, ideal for brainstorming
...
#aiMindMap .e-menu-wrapper ul .e-menu-item.e-menu-caret-icon {
