  ...
  <div id="desc-container">
    ...
    <div class="description-container e-card">
        ...
        <div class='e-card-content '>
            <p>This sample showcases the Smart Editor's capabilities in the Syncfusion Vue Document Editor. It enhances document editing by rewriting, checking grammar, and translating text. Users can refine content through selection context, improving writing quality with grammar corrections, paraphrasing for readability, and translating into different languages - all within the editor. Know more <a href="https://github.com/syncfusion/smart-ai-samples/blob/master/vue/src/ai-components/ai-document-editor/Readme.md">here</a>.
            </p>
        </div>
    </div>  
  </div>
