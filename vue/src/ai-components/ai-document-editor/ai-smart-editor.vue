    ...
    <div class="description-container e-card">
      <div class='e-card-content '>
        <p>This sample showcases the Smart Editor's capabilities in the Syncfusion Vue Document Editor. It enhances
          ...
          selection context, improving writing quality with grammar corrections, paraphrasing for readability, and
          translating into different languages - all within the editor. Know more <a
