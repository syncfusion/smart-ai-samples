<template>
    <div class='control-pane'>
        <div class='control-section'>
            ...
            <div id='container'>
                <ejs-grid id='Grid' ref="gridInstance" :dataSource="machineDataList" toolbarTemplate = "toolbarTemplate"
                    ...
                    <template #toolbarTemplate>
                        <ejs-button id='anomaly' :isPrimary='true' @click='DetectAnomalyData'>Detect Anomaly Data</ejs-button>
                    </template>
                </ejs-grid>
            </div>
        </div>
