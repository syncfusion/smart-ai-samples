      ...
      <div class="description-container e-card">
        <div class="e-card-content">
          <p>
            ...
            based on the grid's existing entries. Know more <a
              href="https://github.com/syncfusion/smart-ai-samples/blob/master/vue/src/ai-components/ai-grid/Readme.md">here</a>.
          </p>
        </div>
      </div>
      <div id="container">
        <ejs-grid ref="grid" :dataSource="predictiveData" toolbarTemplate="toolbarTemplate" allowSelection: false
          :queryCellInfo="CustomizeCell" :enableHover="false">
          <e-columns>
            <e-column field="StudentID" isPrimaryKey="true" headerText="Student ID" textAlign="Right"
              width="100"></e-column>
            ...
            <e-column field="SecondYearGPA" headerText="Second Year GPA" headerTextAlign="Center" textAlign="Center"
              width="100"></e-column>
            <e-column field="ThirdYearGPA" headerText="Third Year GPA" headerTextAlign="Center" textAlign="Center"
              width="100"></e-column>
            <e-column field="FinalYearGPA" headerText="Final Year GPA" :visible="false" headerTextAlign="Center"
              textAlign="Center" width="100"></e-column>
            <e-column field="TotalGPA" headerText="Total GPA" :visible="false" headerTextAlign="Center"
              textAlign="Center" width="100"></e-column>
            <e-column field="TotalGrade" headerText="Total Grade" :visible="false" headerTextAlign="Center"
              textAlign="Center" width="100"></e-column>
          </e-columns>
          <template #toolbarTemplate>
            <ejs-button id='calculate_Grade' :isPrimary='true' @click='CalculateGrade'>Calculate Grade</ejs-button>
          </template>
        </ejs-grid>
      </div>
    </div>
...
export default {
  ...
  methods: {
        ...
        .then((result) => {
          try {
            ...
            if (generatedData.length) {
              this.$refs.grid.showColumns(['FinalYearGPA', 'TotalGPA', 'TotalGrade'], 'field');
    ...
    updateRows: async function(generatedData) {
