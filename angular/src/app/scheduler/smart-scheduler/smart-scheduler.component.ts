...
import { ButtonModule, ChatOptions } from '@syncfusion/ej2-angular-buttons';
...
export class SmartSchedulerComponent {
  ...
  public attachEvent(e: Event): void {
    ...
    let location = (document.getElementById('location') as HTMLInputElement)
      .value;
    let startTime = (this.daterange1 as any).inputElement.value;
    let endTime = (this.daterange2 as any).inputElement.value;
    let description = (
