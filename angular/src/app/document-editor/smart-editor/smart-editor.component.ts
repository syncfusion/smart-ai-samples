import { Component, ViewChild, OnInit,contentChildren } from '@angular/core';
...
import { DialogAllModule, ButtonPropsModel, DialogComponent, ButtonProps, showSpinner, hideSpinner,createSpinner } from '@syncfusion/ej2-angular-popups';
