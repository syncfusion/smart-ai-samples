import { Connector, ConnectorModel, Diagram, NodeModel,Node, NodeConstraints, randomId, UserHandleModel, Side, MarginModel, HorizontalAlignment, VerticalAlignment, DiagramTools, IExportOptions, FileFormats, SnapConstraints } from "@syncfusion/ej2/diagrams";
import {  diagram, MindMapData, toolbarObj } from "./app";
...
export function pushWorkingData(diagram: Diagram) {
    workingData = [];
  ...
  export function addSibilingChild() {
    var selectedNode: any = diagram.selectedItems.nodes[0];
 ...
 export function setConnectorDefault(diagram: Diagram, orientation: string, connector: Connector, sourceID: string, targetID: string) {
 ...
 export function removeSubChild(node: Node,diagram: Diagram) {
